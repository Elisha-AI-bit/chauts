                ...
                <div class="p-6 text-gray-900 border-b border-gray-200">
                    <form method="POST" action="{{ route('courses.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="course_code" class="block mt-1 w-full border-gray-300 focus:border-chalimbana-gold focus:ring-chalimbana-gold rounded-md shadow-sm" type="text" name="course_code" :value="old('course_code')" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="course_name" class="block mt-1 w-full border-gray-300 focus:border-chalimbana-gold focus:ring-chalimbana-gold rounded-md shadow-sm" type="text" name="course_name" :value="old('course_name')" required />
                        ...
                        <div class="flex space-x-4 mt-4">
                            ...
                            <div class="w-1/2">
                                ...
                                <x-text-input id="year" class="block mt-1 w-full border-gray-300 focus:border-chalimbana-gold focus:ring-chalimbana-gold rounded-md shadow-sm" type="number" min="1" max="7" name="year" :value="old('year', 1)" required />
                            ...
                            <div class="w-1/2">
                                ...
                                <x-text-input id="semester" class="block mt-1 w-full border-gray-300 focus:border-chalimbana-gold focus:ring-chalimbana-gold rounded-md shadow-sm" type="number" min="1" max="3" name="semester" :value="old('semester', 1)" required />
