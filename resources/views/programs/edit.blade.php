                ...
                <div class="p-6 text-gray-900 border-b border-gray-200">
                    <form method="POST" action="{{ route('programs.update', $program->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="program_name" class="block mt-1 w-full border-gray-300 focus:border-chalimbana-gold focus:ring-chalimbana-gold rounded-md shadow-sm" type="text" name="program_name" :value="old('program_name', $program->program_name)" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="faculty" class="block mt-1 w-full border-gray-300 focus:border-chalimbana-gold focus:ring-chalimbana-gold rounded-md shadow-sm" type="text" name="faculty" :value="old('faculty', $program->faculty)" required />
