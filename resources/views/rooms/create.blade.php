            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 border-b border-gray-200">
                    <form method="POST" action="{{ route('rooms.store') }}">
                        ...
                        <!-- Room Name -->
                        <div class="mt-4">
                            <x-input-label for="room_name" :value="__('Room Name (e.g. LT1, Hall A)')" />
                            <x-text-input id="room_name" class="block mt-1 w-full border-gray-300 focus:border-chalimbana-gold focus:ring-chalimbana-gold rounded-md shadow-sm" type="text" name="room_name" :value="old('room_name')" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="capacity" class="block mt-1 w-full border-gray-300 focus:border-chalimbana-gold focus:ring-chalimbana-gold rounded-md shadow-sm" type="number" name="capacity" :value="old('capacity')" required />
